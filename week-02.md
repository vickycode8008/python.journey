...
- [x] Understand how Python evaluates `True`/`False` expressions
...
> 🐍 **Week 2 / Day 14 of learning Python — decisions, loops, and my first game!**
>
> This week I dove into the heart of programming logic with Abdulbari's Python course:
>
> ✅ `if / elif / else` — writing code that makes decisions
> ✅ `for` and `while` loops — automating repetition
> ✅ Nested loops — generating patterns like multiplication tables and triangles
>
> The highlight of the week? Building a number guessing game from scratch! It's simple, but watching the loop keep running until the right answer clicked something in my brain about how programs *think*.
>
> Short circuit evaluation (`and`, `or`) was also a fun discovery — Python is smart enough to skip unnecessary checks. That kind of efficiency is satisfying to learn.
>
> For anyone who's learned loops: what's the first real-world problem you solved with one? I'd love some inspiration for next week!
>
